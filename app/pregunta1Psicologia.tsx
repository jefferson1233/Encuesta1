...
const sustancias = [
    { letra: "a", nombre: "Mucha Tensión (3)" },
    { letra: "b", nombre: "Alguna Tensión (2)" },
    { letra: "c", nombre: "Ninguna Tensión (1)" },
    /*
...
export default function Pregunta1_({ onSubmit }: Props) {
    ...
    return (
        ...
        <div className="max-w-5xl mx-auto p-6 ">
            ...
            <p className="mb-6 text-gray-700">
                <strong>En general, ¿cómo describiría su relación con su pareja?</strong>
            </p>
